        ...
        final GestureDetectorCompat gestureDetector = new GestureDetectorCompat(this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                if (e1.getX() - e2.getX() > threshold) {
                    ...
                    Toast.makeText(MainActivity.this, "horizontal nichts", Toast.LENGTH_SHORT).show();
                }

                if (e1.getY() - e2.getY() > threshold) {
                    Toast.makeText(MainActivity.this, "swipe hoch", Toast.LENGTH_SHORT).show();
                } else if (e2.getY() - e1.getY() > threshold) {
                    Toast.makeText(MainActivity.this, "swipe runter", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, "vertikal nichts", Toast.LENGTH_SHORT).show();
                }
                return true;
            }
        }
